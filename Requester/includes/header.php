...
<body>
 ...
 <nav class="navbar navbar-dark fixed-top bg-danger flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="RequesterProfile.php">Local Service Provider</a>
 </nav>
   ...
   <nav class="col-sm-2 bg-light sidebar py-5 d-print-none">
    <div class="sidebar-sticky">
     <ul class="nav flex-column">
      ...
      <li class="nav-item">
            <a class="nav-link <?php if(PAGE == 'UpdateRequest') { echo 'active'; } ?>" href="UpdateRequest.php">
              <i class="fas fa-edit"></i>
              Update Request
            </a>
          </li>
        <li class="nav-item">
         <a class="nav-link <?php if(PAGE == 'PayOnline') { echo 'active'; } ?>" href="PayOnline.php">
